...
class SM_Admin_Menus {
	...
	public function import_export_menu() {
		add_submenu_page( 'edit.php?post_type=wpfc_sermon', __( 'Sermon Manager Import/Export', 'audiopod-wp' ), __( 'Import/Export', 'audiopod-wp' ), 'manage_wpfc_sm_settings', 'sm-import-export', array(
			$this,
			'import_export_page',
		) );
	}
