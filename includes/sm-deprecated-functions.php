...
function render_wpfc_sermon_archive() {
	...
	$title = printf( esc_attr__( 'Permalink to %s', 'audiopod-wp' ), the_title_attribute( 'echo=0' ) );
	?>
	<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="wpfc_sermon_meta cf">
			...
			<p>
				<?php
				wpfc_sermon_meta( 'bible_passage', '<span class="bible_passage">' . __( 'Bible Text: ', 'audiopod-wp' ), '</span> | ' );
				the_terms( $post->ID, 'wpfc_preacher', '<span class="preacher_name">', ' ', '</span>' );
				the_terms( $post->ID, 'wpfc_sermon_series', '<p><span class="sermon_series">' . __( 'Series: ', 'audiopod-wp' ), ' ', '</span></p>' );
				?>
			</p>
		</div>
	</div>
	...
	if ( SM_OB_ENABLED ) {
		...
		<div class="wpfc_sermon_wrap cf">
			...
			<div class="wpfc_sermon_meta cf">
				...
				<p>
					<?php the_terms( $post->ID, 'wpfc_sermon_series', '<span class="sermon_series">' . __( 'Series: ', 'audiopod-wp' ), ' ', '</span>' ); ?>
				</p>
			</div>
...
function wpfc_sermon_single( $return = false, $post = null ) {
	...
	if ( SM_OB_ENABLED ) {
		...
		<div class="wpfc_sermon cf">
			...
			<?php the_terms( $post->ID, 'wpfc_sermon_topics', '<p class="sermon_topics">' . __( 'Sermon Topics: ', 'audiopod-wp' ), ',', '</p>' ); ?>
